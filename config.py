...
# Thumbnail URL
THUMB_URL = os.environ.get("THUMB_URL", "https://telegra.ph/file/891fe46cf30093512940d.jpg")
# Your Updates Channel! Don't Put Anything If you don't have one
UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "sl_bot_zone")
...
UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://telegra.ph/file/891fe46cf30093512940d.jpg")
U_BRANCH = "master"
