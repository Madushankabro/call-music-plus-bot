...
async def addchannel(client, message):
    ...
    try:
        ...
        await message.reply_text(
            "<b>tf? Add me as admin of yor group first! Then Use This Command!</b> 👮‍♀️",
        )
        return
    ...
    try:
        ...
        user.first_name =  "@vcpalyassistant" # F this

    try:
        await USER.join_chat(invitelink)
        await USER.send_message(message.chat.id,"Ok! I joined here as you requested! Don't Spam or Else ")
